...
(() => {
  ...
  // chain through SM-207 post and SM-300 bounded occluder/tile preparation. Auto
  // remains WebGL2 until SM-505; staged WebGPU modules do not change presentation.
  const backendReady = import('./engine/webgpu_device.js?v=sm102-1')
    ...
    .catch(err => {
      ...
      console.warn('WebGPU staged renderer lifecycle through post/occluder preparation unavailable; continuing with WebGL2.', err);
      return null;
    });
