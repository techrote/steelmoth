...
if errors:
    ...
    for error in errors:
        print(" -", error)
    raise SystemExit(1)
print("WEBGPU TARGET BENCHMARK CONTRACT PASS: production chain, total-only SM-501 timing, GTAO physical gate, raw samples, canonical matrix and strict report validators are wired")
