...
assert "small-machine-web-v1.2.3-r1" in sw
...
print('WEBAPP V1.2.3 PASS: full version/cache closure, 9 rooms/27 objectives, Material-v2 assets present, 193/257-ray visibility profile declared')
