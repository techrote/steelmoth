...
# added. Require an explicit v1.2.3 revision rather than pinning a historical number.
...
print('WEBAPP V1.2.3 PASS: version/cache closure, 9 rooms/27 objectives, Material-v2 assets, staged SM-101 transforms through SM-204 canonical lighting runtime present, 193/257-ray visibility profile declared')
