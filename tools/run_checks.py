...
CHECKS = [
    ...
    ("js-pseudo-depth", "source", ["node", "--check", "engine/pseudo_depth.js"]),
    ...
    ("js-webgpu-ownership", "source", ["node", "--check", "engine/webgpu_ownership.js"]),
    ("js-webgpu-depth-hierarchy", "source", ["node", "--check", "engine/webgpu_depth_hierarchy.js"]),
    ("js-webgpu-lighting", "source", ["node", "--check", "engine/webgpu_lighting.js"]),
    ("js-webgpu-local-shadows", "source", ["node", "--check", "engine/webgpu_local_shadows.js"]),
    ("js-webgpu-transparent-fx", "source", ["node", "--check", "engine/webgpu_transparent_fx.js"]),
    ("js-webgpu-water", "source", ["node", "--check", "engine/webgpu_water.js"]),
    ("js-webgpu-foliage", "source", ["node", "--check", "engine/webgpu_foliage.js"]),
    ("js-webgpu-clusters", "source", ["node", "--check", "engine/webgpu_clusters.js"]),
    ("js-webgpu-dominance", "source", ["node", "--check", "engine/webgpu_dominance.js"]),
    ("js-webgpu-transition-state", "source", ["node", "--check", "engine/webgpu_transition_state.js"]),
    ("js-webgpu-gtao", "source", ["node", "--check", "engine/webgpu_gtao.js"]),
    ...
    ("pseudo-depth", "regression", ["node", "tools/validate_pseudo_depth.js"]),
    ("pseudo-depth-contract", "regression", [PY, "tools/validate_pseudo_depth_contract.py"]),
    ...
    ("webgpu-ownership", "regression", ["node", "tools/validate_webgpu_ownership.js"]),
    ("webgpu-ownership-contract", "regression", [PY, "tools/validate_webgpu_ownership_contract.py"]),
    ...
    ("webgpu-local-shadows", "regression", ["node", "tools/validate_webgpu_local_shadows.js"]),
    ("webgpu-local-shadows-contract", "regression", [PY, "tools/validate_webgpu_local_shadows_contract.py"]),
    ("webgpu-transparent-fx", "regression", ["node", "tools/validate_webgpu_transparent_fx.js"]),
    ("webgpu-transparent-fx-contract", "regression", [PY, "tools/validate_webgpu_transparent_fx_contract.py"]),
    ("webgpu-water", "regression", ["node", "tools/validate_webgpu_water.js"]),
    ("webgpu-water-contract", "regression", [PY, "tools/validate_webgpu_water_contract.py"]),
    ("webgpu-foliage", "regression", ["node", "tools/validate_webgpu_foliage.js"]),
    ("webgpu-foliage-contract", "regression", [PY, "tools/validate_webgpu_foliage_contract.py"]),
    ("webgpu-clusters", "regression", ["node", "tools/validate_webgpu_clusters.js"]),
    ("webgpu-clusters-contract", "regression", [PY, "tools/validate_webgpu_clusters_contract.py"]),
    ...
    ("webgpu-transition", "regression", ["node", "tools/validate_webgpu_transition.js"]),
    ("webgpu-transition-contract", "regression", [PY, "tools/validate_webgpu_transition_contract.py"]),
    ("webgpu-gtao", "regression", ["node", "tools/validate_webgpu_gtao.js"]),
