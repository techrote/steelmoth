...
print(f'VISUAL MATERIAL PASS: semantic box/barrel/pole/pipe/floor/robot response, bounded painted-steel weathering, exact roots, and crate height self-shadow blockers ({blocked}/{tested})')
