'use strict';
const CACHE = 'small-machine-web-v1.2.3-r22';
const CORE = [
  ...
  './engine/webgpu_gbuffer.js?v=sm200-1', './engine/webgpu_ownership.js?v=sm202-1', './engine/webgpu_depth_hierarchy.js?v=sm203-1', './engine/webgpu_lighting.js?v=sm204-1', './engine/webgpu_local_shadows.js?v=sm205-1', './engine/webgpu_transparent_fx.js?v=sm206-1', './engine/webgpu_post.js?v=sm207-1', './engine/webgpu_occluders.js?v=sm300-1', './engine/webgpu_clusters.js?v=sm301-1', './engine/webgpu_dominance.js?v=sm302-1', './engine/webgpu_dso.js?v=sm303-1', './engine/webgpu_dso_hierarchy.js?v=sm304-1', './engine/webgpu_dark_bloom.js?v=sm305-1', './engine/webgpu_dark_bloom_temporal.js?v=sm306-1', './engine/webgpu_visibility.js?v=sm307-1', './engine/webgpu_water.js?v=sm400-1', './engine/webgpu_foliage.js?v=sm401-1', './engine/webgpu_ordering.js?v=sm402-1', './engine/webgpu_editor_state.js?v=sm403-1', './engine/backend_runtime.js?v=sm102-1',
